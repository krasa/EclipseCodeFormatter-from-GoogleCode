...
public class JSCodeFormatterFacade extends CodeFormatterFacade {
    ...
    private org.eclipse.wst.jsdt.core.formatter.CodeFormatter getCodeFormatter() throws FileDoesNotExistsException {
        if (codeFormatter == null || propertiesProvider.wasChanged()) {
    ...
    private org.eclipse.wst.jsdt.core.formatter.CodeFormatter newCodeFormatter() throws InvalidPropertyFile {
        codeFormatter = org.eclipse.wst.jsdt.core.ToolFactory.createCodeFormatter(propertiesProvider.getProperties());
        return codeFormatter;
    }
    ...
    protected String formatInternal(String text, int startOffset, int endOffset) throws FileDoesNotExistsException {
        ...
        try {
            ...
            TextEdit edit = getCodeFormatter().format(
                    org.eclipse.wst.jsdt.core.formatter.CodeFormatter.K_JAVASCRIPT_UNIT, text, startOffset,
